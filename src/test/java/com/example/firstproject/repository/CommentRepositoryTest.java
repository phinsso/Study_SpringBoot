...
@DataJpaTest // 해당 클래스를 JPA와 연동해 테스트하겠다 선언
class CommentRepositoryTest {
    ...
    @Test
    @DisplayName("특정 게시글의 모든 댓글 조회") // 메서드명을 수정하지 않고 어노테이션 사용
    void findByArticleId() {
        ...
        // Case 3: 9번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글은 게시글 자체가 없으므로 비어있음");
        }
        ...
        // Case 4: 999번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글은 게시글 자체가 없으므로 비어있음");
        }
    ...
    void findByNickname() {
        ...
        // Case 2: "Kim"의 모든 댓글 조회
        {
            ...
            Comment b = new Comment(5L, new Article(5L, "당신의 소울 푸드는?", "댓글 고고"), nickname, "피자");
